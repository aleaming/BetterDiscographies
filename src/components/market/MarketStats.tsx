...
import { ChevronDown, DollarSign, TrendingUp, History, LineChart } from 'lucide-react';
...
export function MarketStats({ id }: MarketStatsProps) {
  ...
  useEffect(() => {
    async function fetchMarketData() {
      ...
      try {
        ...
        const data = await client.getMarketData(id);
        setMarketData(data);
      } catch (err) {
